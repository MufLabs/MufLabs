...
export class OpenAICompatibleErrorMapper {
    static map(error, provider = "OpenAI Compatible") {
    ...
    static fromHttpStatus(status, message, provider = "OpenAI Compatible") {
        switch (status) {
            case 400:
...
//# sourceMappingURL=OpenAICompatibleErrorMapper.js.map